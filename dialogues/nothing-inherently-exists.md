...
Eurus:: What does it mean to say something "influences reality" or that something "can't be broken into smaller pieces"? Our discussion reminds me of a passage in _The Feynman Lectures_ about the philosophical implications of quantum mechanics that may be helpful. I'll read it:
...
Dijon:: The ideas in this passage can indeed improve my definition: Let's say something _fundamentally exists_ if it is an irreducible construct in a theory that explains all our empirical observations.
...
Dijon:: Such constructs do _feel_ like mathematical machinery. But how could it be otherwise? If the universe consists of small and simple particles and eyes are large and complex aggregates of particles, then eyes would necessarily not be able to see particles. If we also assume that the universe is ordered, then particles would follow mathematical laws and would be indirectly-known mathematical machinery.

Eurus:: Are you sure an eye _necessarily_ couldn't see a single particle? In our universe, human eyes can detect individual photons.
...
Dijon:: If a wave function snapshot fully determines the next snapshot, then it seems the _essence_ of the wave function is present in the first snapshot.
